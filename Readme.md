# Here is the native firmware for AD5M, AD5MPro, AD5X printers

[Here is the native firmware for AD5M, AD5MPro, AD5X printers](https://github.com/ghzserg/FF/releases/R)

# Здесь находится родная прошивка для принтеров AD5M, AD5MPro, AD5X
...
## AD5X native firmware (AD5X родная прошивка)
...
For those who've lost their minds and moved their "home" (parking lot to the shit bin). Extract the archive contents to the root of a flash drive, insert the flash drive, and reboot the printer. The calibration will load. First, press Reset. Then, use the on-screen control buttons to adjust the correct head position. Press the Set button to lock this. Reboot the printer without the flash drive. Archive from official Flashforge support.
...
# E0011 native firmware (E0011 на родной прошивке)

[fix_e0011 Ru](https://github.com/ghzserg/FF/wiki/Global_ru#fix_e0011)
[fix_e0011 En](https://github.com/ghzserg/FF/wiki/Global_en#fix_e0011)
...
# E0017 native firmware (E0017 на родной прошивке)

[fix_e0017 Ru](https://github.com/ghzserg/FF/wiki/Global_ru#fix_e0017)
[fix_e0017 En](https://github.com/ghzserg/FF/wiki/Global_en#fix_e0017)
...
- [Инструкция по восстановлению прошивки IFS](https://github.com/ghzserg/FF/wiki/AD5X.md#11-%D0%B2%D0%BE%D1%81%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D0%BF%D1%80%D0%BE%D1%88%D0%B8%D0%B2%D0%BA%D0%B8-ifs)
- [IFS Firmware Recovery](https://github.com/ghzserg/FF/wiki/AD5X_en#11-ifs-firmware-recovery)
